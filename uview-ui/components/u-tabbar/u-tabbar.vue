<template>
	<view v-if="show" class="u-tabbar" @touchmove.stop.prevent="() => {}">
		<view class="u-tabbar__content" :style="{
			...
			<view class="u-tabbar__content__item u-tabbar_content_box" v-for="(item, index) in list" 
			:key="index" 
			:class="[
				item.text == '首页' ? 'u-tabbar_content_box_left' : ''
				]"
...
<style scoped lang="scss">
	...
	.u-tabbar {
		...
		.u-tabbar_content_box{
			// border-left: 2rpx solid #a39c9c;
			border-right: 2rpx solid #c3ad86;
		}
		.u-tabbar_content_box_left{
			border-left: 2rpx solid #c3ad86;
			// border-right: 2rpx solid #a39c9c;
		}
		&__content {
			@include vue-flex;
			align-items: center;
