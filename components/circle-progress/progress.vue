<template>
	<view :style="containerStyle">
		<view :style="cBox">
			...
			<view class="container_out"  :style="faStyle">
				<view class="pro_left" :style="leftBox">
					<view class="pro_l"  :style="leftStyle"></view>
				</view>
...
<script>
	export default {
		...
		computed:{
			...
			containerStyle() {
				var innerbgColor = this.innerbgColor
				var style=
					`	
			...
			leftStyle(){
				...
				style= `
					...
					clip:rect(0 ${circleWidth*2+size}px ${circleWidth*2+size}px ${(circleWidth*2+size)/2-4}px ) !important;
					`;
				return style;
			},
			rithStyle(){
