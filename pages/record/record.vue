<template>
	<view class="record_">
		<view class="record_pop daxigua">
			<!-- <view class="record_back">
				
			</view>
		    <view class="record_title">
		        {{indexLocales.history}}
		    </view> -->
			<u-navbar :is-back="true" :title="indexLocales.history" :background="{ background: '#000000' }" height="42" title-color="#fff"
	...
	.record_{
	    ...
	    .record_pop {
	        ...
	        .record_table {
	            ...
	            .tableTitle {
	                height: 60rpx;
	                border-bottom: 2rpx solid #17c4ff;
	                display: flex;
	                justify-content: space-between;
	                align-items: center;
