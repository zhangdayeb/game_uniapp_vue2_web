  ...
  methods: {
    ...
    initSocket() {
      ...
      this.gameSocket.on('maxReconnectAttemptsReached', () => {
        ...
        this.$tip.alert('网络连接失败，请检查网络后重新进入')
      })
    },
    ...
    // 原有的其他方法保持不变，但需要将socketTask.sendMsg替换为this.sendSocketMessage
    // 例如：
